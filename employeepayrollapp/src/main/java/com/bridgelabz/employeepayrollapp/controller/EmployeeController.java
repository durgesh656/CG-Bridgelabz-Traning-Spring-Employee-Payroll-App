...
public class EmployeeController {
    ...
    @GetMapping("/all")    //get list of employee
    ...
    public ResponseEntity<EmployeeEntity> updateEmployeeDetails(@PathVariable Long id, @Valid @RequestBody EmployeeEntity updatedEmployee) {
